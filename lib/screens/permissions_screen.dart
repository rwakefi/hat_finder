                ...
                child: ConstrainedBox(
                  ...
                  child: Padding(
                    padding: EdgeInsets.symmetric(
                      horizontal: compact ? 28.0 : 40.0,
                      vertical: compact ? 20.0 : 32.0,
                    ),
                    child: Column(
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                'Hat Finder uses a short fit quiz, your location, '
                                'and current Moon Ridge inventory to recommend '
                                'styles that are easier to shop and compare.',
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                  fontSize: 15,
                                  color:
                              ...
                              _buildPermissionItem(
                                ...
                                description:
                                    'To help you find nearby stores and local product options.',
                              ),
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      'No photo or camera analysis is used in this version.',
                                      style: TextStyle(
                                        fontSize: 13,
                                        color: const Color(0xFF2D2926)
                                            .withOpacity(0.7),
