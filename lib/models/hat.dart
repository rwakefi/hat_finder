...
const List<HatShapeInfo> crownShapes = [
  HatShapeInfo('Cattleman\'s', 'assets/images/crowns/cattleman.png', 'Classic crease, most popular style.',
    ...
    physicalDescription: 'Three distinct creases run the length of the crown — one center dent flanked by two side pinches. Crown height typically ranges from 4" to 4½". The most versatile crown shape.',
    galleryImages: ['assets/images/crowns/cattleman.png', 'assets/images/crowns/brick.png']),
  HatShapeInfo('Pinch Front', 'assets/images/crowns/pinch_front.png', 'Modern sharp crease with distinct front pinches.',
    history: 'The Pinch Front crown has long been a staple of both western wear and traditional dress hats. Its clean, sharp look became immensely popular as it creates a narrow, aerodynamic visual profile.',
    famousWearers: [
      {'name': 'Vintage Fashion Icons', 'context': 'The pinch front was the signature crease of mid-century high-society travel hats.'},
    ],
    physicalDescription: 'A sharp center crease with two distinct, deep pinches at the front. Crown height is typically 4" to 4½".',
  ...
  HatShapeInfo('Gus', 'assets/images/crowns/gus.png', 'High slanted back with three prominent dimples.',
    history: 'Made famous by Augustus "Gus" McCrae in "Lonesome Dove," this crown blends Hollywood romance with authentic ranch heritage.',
    famousWearers: [
      {'name': 'Robert Duvall', 'context': 'Immortalized this crown shape as Gus McCrae in "Lonesome Dove" (1989).'},
      {'name': 'Sam Elliott', 'context': 'Has been seen sporting Gus-style crowns throughout his career.'},
    ],
    physicalDescription: 'A high crown (4½" to 5½") with a distinctive forward slope and three prominent dimples.',
  ...
  HatShapeInfo('Teardrop', 'assets/images/crowns/teardrop.png', 'Classic fedora-style teardrop pinch.',
    history: 'Traces its roots to European fedora styling of the early 20th century — equally at home on Broadway or the back forty.',
    famousWearers: [
      {'name': 'Frank Sinatra', 'context': 'Made the teardrop fedora a symbol of smooth sophistication.'},
      {'name': 'Indiana Jones (Harrison Ford)', 'context': 'The adventurer\'s iconic hat features a teardrop-inspired crown pinch.'},
    ],
    physicalDescription: 'A teardrop-shaped pinch at the front, tapering to a subtle point. Crown height is typically 4" to 4½".',
  ...
  HatShapeInfo('Telescope', 'assets/images/crowns/telescope.png', 'Flat "pork-pie" style circular crease.',
    history: 'Features a flat circular indent that creates a distinctive cylinder shape — popularized by jazz musicians and adopted by southwestern ranchers.',
    famousWearers: [
      {'name': 'Lester Young', 'context': 'Made the pork pie/telescope hat his iconic signature.'},
    ],
    physicalDescription: 'A flat, circular indent on top creating a telescope or cylinder shape. Height is typically 3¾" to 4½".',
  ...
  HatShapeInfo('Gambler', 'assets/images/crowns/gambler.png', 'Classic flat-topped crown with circular indent.',
    history: 'Associated with riverboat players and classic western films — a low, flat circular top designed to sit securely in wind.',
    famousWearers: [
      {'name': 'Riverboat Players', 'context': 'The low circular top stayed secure during windy river crossings.'},
    ],
    physicalDescription: 'A low-profile crown with a flat top and subtle circular crease around the edge. Typically 3¾" to 4".',
  ...
  HatShapeInfo('Brick', 'assets/images/crowns/brick.png', 'Squared-off crease, great for a wider profile.',
    history: 'Popular among ranchers in the Northern Plains and Rocky Mountain states for excellent sun coverage and a commanding silhouette.',
    famousWearers: [
      {'name': 'Wyoming & Montana Ranchers', 'context': 'The Brick is the signature crown of the Northern Plains.'},
    ],
    physicalDescription: 'A flat-topped, rectangular crown with squared-off edges. Typical height is 4" to 4½".',
  ...
  HatShapeInfo('Texas Punch', 'assets/images/crowns/texas_punch.png', 'Distinctive high pinched front.',
...
const List<HatShapeInfo> brimShapes = [
  HatShapeInfo('Slightly Curved', 'assets/images/placeholder.png', 'Gentle, subtle curve along the brim edge.',
    history: 'A refined everyday brim with just enough curve to soften the silhouette without going full dress or rodeo.',
    famousWearers: [],
    physicalDescription: 'A light, even curve around the brim — dressy but understated. Works well with city and fedora crowns.',
  ...
  HatShapeInfo('Medium Curved', 'assets/images/placeholder.png', 'Classic moderately curved western brim.',
    ...
    galleryImages: ['assets/images/placeholder.png']),
  HatShapeInfo('CHL (Cool Hand Luke)', 'assets/images/placeholder.png', 'Rebellious, low-profile roll brim.',
    ...
    galleryImages: ['assets/images/placeholder.png']),
  HatShapeInfo('J (George Strait)', 'assets/images/placeholder.png', 'Subtle J-shaped upward curl on the sides.',
    history: 'The J curl is a refined twist on the flat brim, with a slight upward sweep at the sides that gives the hat a more finished, dressy appearance.',
    famousWearers: [
      {'name': 'George Strait', 'context': 'Helped popularize the clean J-curl brim in modern western dress wear.'},
    ],
    physicalDescription: 'A slight J-shaped upward curl on both sides, keeping the front and back relatively flat. Width typically 4\" to 4½\".',
    galleryImages: ['assets/images/placeholder.png']),
  HatShapeInfo('WTP (West Texas Punch)', 'assets/images/placeholder.png', 'Wide flat brim with a punched-down front.',
    history: 'Born from the hard-working ranches of West Texas where full sun protection was non-negotiable.',
    famousWearers: [
      {'name': 'West Texas ranchers', 'context': 'Developed this brim style for maximum function in brutal summer heat.'},
    ],
    physicalDescription: 'A wide flat brim with the front edge punched slightly downward for shade without obstructing vision.',
    galleryImages: ['assets/images/placeholder.png']),
  HatShapeInfo('JB', 'assets/images/placeholder.png', 'More pronounced J curl with sharper sweep.',
    history: 'The JB curl takes the J curl further with a more dramatic side sweep, popular in show and cutting circuits.',
    famousWearers: [],
    physicalDescription: 'A sharper, higher J-shaped sweep on both sides. Width typically 4\" to 4½\".',
    galleryImages: ['assets/images/placeholder.png']),
  HatShapeInfo('Shovel Width', 'assets/images/placeholder.png', 'Distinct flat front edge with curled sides.',
    history: 'Designed to maximize forward sightlines and face shading while roping or working cattle.',
    famousWearers: [
      {'name': 'Professional ropers', 'context': 'Favored for clean sightlines and a bold front profile.'},
    ],
    physicalDescription: 'The front edge is flattened straight like a shovel, while the sides are neatly curled up.',
    galleryImages: ['assets/images/placeholder.png']),
  HatShapeInfo('Taco', 'assets/images/placeholder.png', 'Both sides folded up tightly, taco-style.',
    history: 'One of the oldest brim traditions in vaquero culture — both sides fold up sharply for brush country riding.',
    famousWearers: [
      {'name': 'Vaqueros', 'context': 'Developed the taco fold for practical brush-country riding centuries ago.'},
    ],
    physicalDescription: 'Both sides of the brim fold sharply upward creating a taco or shell shape.',
    galleryImages: ['assets/images/placeholder.png']),
  HatShapeInfo('Half Taco/Minnick', 'assets/images/placeholder.png', 'A partial taco fold with a Minnick-style profile.',
    history: 'Blends the vaquero taco tradition with the specialized Minnick crease for a distinctive asymmetric look.',
    famousWearers: [],
    physicalDescription: 'A tighter, partial side fold — less extreme than a full taco, with Minnick character.',
    galleryImages: ['assets/images/placeholder.png']),
  HatShapeInfo('Flip up or Down', 'assets/images/placeholder.png', 'Versatile brim that can be worn flipped up or down.',
    history: 'A flexible dress brim style that adapts to sun, wind, and formal presentation.',
    famousWearers: [],
    physicalDescription: 'Can be shaped with the brim edge turned up or left down depending on look and function.',
    galleryImages: ['assets/images/placeholder.png']),
  HatShapeInfo('Pulled Down', 'assets/images/placeholder.png', 'Brim pulled down for shade and a low profile.',
    history: 'Favored when maximum brow shade and a grounded, understated silhouette are desired.',
    famousWearers: [],
    physicalDescription: 'The brim is shaped downward around the crown for extra shade and a composed look.',
    galleryImages: ['assets/images/placeholder.png']),
  HatShapeInfo('Flanged Brim', 'assets/images/placeholder.png', 'Brim with a defined flanged edge.',
    history: 'The flanged edge adds structure and a crisp finished line — common on dress and heritage felts.',
    famousWearers: [],
    physicalDescription: 'Features a distinct turned or flanged outer edge for a sharp, tailored outline.',
    galleryImages: ['assets/images/placeholder.png']),
  HatShapeInfo('Pencil Curl', 'assets/images/placeholder.png', 'Tight, fine curl along the brim edge.',
    history: 'A precise dress brim finish — the curl is narrow and crisp like a pencil line.',
    famousWearers: [],
    physicalDescription: 'A very tight, narrow curl around the brim perimeter. Elegant and formal.',
    galleryImages: ['assets/images/placeholder.png']),
  HatShapeInfo('Flat/RD (Round)', 'assets/images/placeholder.png', 'Flat brim or rolled round (RD) profile.',
    history: 'Combines the classic flat brim with the rolled round curl popular in southwest dress wear.',
    famousWearers: [
      {'name': 'Southwest ranch hands', 'context': 'The rolled round profile balances sightlines with a finished town look.'},
    ],
    physicalDescription: 'Either a level flat brim or sides curled in a continuous round profile.',
    galleryImages: ['assets/images/placeholder.png']),
];
